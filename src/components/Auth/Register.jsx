...
const Register = () => {
  ...
  return <Container h={'auto'} p={"50px 0"}>
    <VStack h={'full'} justifyContent="center" spacing={'16'} >
        ...
        <form onSubmit={submitHandler} style={{width:"100%"}}>
            ...
            <Box my={'4'}>
                ...
                placeholder="Name" type={"text"} focusBorderColor="yellow.500"/>
            </Box>
            <Box my={'4'}>
            ...
            <Box my={'4'}>
                ...
                <Input accept="image/*" required id="chooseAvatar" 
                 type={"file"} focusBorderColor="yellow.500" css={fileUploadsStyle}
